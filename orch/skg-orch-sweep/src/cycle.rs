...
//! logic can be tested independently of any concrete [`skg_op_sweep`]
...
use skg_op_sweep::{CompareConfig, SweepVerdict, VerdictStatus};
...
pub struct OrchestratorConfig {
    ...
    /// Path to the `skg-state-sqlite` database used for budget persistence.
...
mod tests {
    use super::*;
    use skg_op_sweep::{EvidenceStance, ProcessorTier};
    ...
    // -----------------------------------------------------------------------
    // EvidenceStance import smoke-test (ensures skg-op-sweep re-export works)
    // -----------------------------------------------------------------------
